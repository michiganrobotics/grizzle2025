...
(function () {
  const weeks = [
    ...
    { week: "Week 14", monday: "2026-11-30", lectures: "L25, L26", tuesday: "L25 Finish C10 Laplace Transforms and Feedback Control (no scheduled lecture check-in)", thursday: "L26 In Class Quiz, no Points (no scheduled lecture check-in)", content: "L25: Finish Chapter 10 Laplace Transforms and Feedback Control (no scheduled lecture check-in); L26: In-class quiz / no points (no scheduled lecture check-in)", assignments: "HW08 due Friday midnight Test 5 open M-F 2026-11-30 to 2026-12-04", notes: "N. Campus Testing Center" },
    { week: "Week 15", monday: "2026-12-07", lectures: "L27, L28", tuesday: "L27 Special Topics / Project Help (no scheduled lecture check-in)", thursday: "L28 Practice Final Exam Review (no scheduled lecture check-in)", content: "L27: Special topics, project help, or make-up work (no scheduled lecture check-in); L28: Practice final exam and final exam review (no scheduled lecture check-in)", assignments: "Project 3 due Friday midnight", notes: "" },
